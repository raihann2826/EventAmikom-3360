            ...
            <tbody class="divide-y border-t">
                <tr class="hover:bg-slate-50/50 transition">
                    ...
                    <td class="px-8 py-6">
                        ...
                        <p class="text-xs text-slate-400">16 Nov 2024 • 19:30 WIB</p>
                    </td>
                    <td class="px-8 py-6">
                        <span class="px-3 py-1 bg-purple-100 text-purple-700 rounded-lg text-xs font-bold">Musik</span>
                    </td>
                    <td class="px-8 py-6">
                ...
                <tr class="hover:bg-slate-50/50 transition">
                    ...
                    <td class="px-8 py-6">
                        ...
                        <p class="text-xs text-slate-400">26 Okt 2024 • 09:00 WIB</p>
                    </td>
                    <td class="px-8 py-6">
                        <span class="px-3 py-1 bg-blue-100 text-blue-700 rounded-lg text-xs font-bold">Tech</span>
                    </td>
                    <td class="px-8 py-6">
                ...
                <tr class="hover:bg-slate-50/50 transition">
                    ...
                    <td class="px-8 py-6">
                        <p class="font-black text-slate-800">Hackathon 2024</p>
                        <p class="text-xs text-slate-400">3 Nov 2024 • 08:00 WIB</p>
                    </td>
                    <td class="px-8 py-6">
                        <span class="px-3 py-1 bg-orange-100 text-orange-700 rounded-lg text-xs font-bold">Kompetisi</span>
                    </td>
                    <td class="px-8 py-6">
                        <p class="font-bold text-green-600">GRATIS</p>
                        <p class="text-xs text-slate-400">Stok: 80/100</p>
                    </td>
                    <td class="px-8 py-6">
                        <div class="flex gap-2">
                            <button class="p-2.5 bg-indigo-50 text-indigo-600 rounded-xl hover:bg-indigo-600 hover:text-white transition">
